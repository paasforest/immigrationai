...
# Deploy Document Checklist Updates to Hetzner Production Server
# Server: 78.46.183.41
# Backend: /var/www/immigrationai/backend
# Usage: ./deploy-checklist-updates.sh

set -e

echo "🚀 Deploying Document Checklist Updates to Hetzner"
echo "===================================================="
echo ""
...
echo "  ✅ Document Checklist Generator freshness tracking"
echo "  ✅ Force refresh option (refresh=true parameter)"
echo "  ✅ Last updated timestamp display"
echo "  ✅ Regenerate button functionality"
echo "  ✅ Outdated warning (6+ months old)"
echo "  ✅ Enhanced AI prompt for current information"
echo ""
echo -e "${BLUE}Next steps:${NC}"
echo "  1. Test checklist: https://immigrationai.co.za/documents/checklist"
echo "  2. Monitor logs: ssh $SERVER 'pm2 logs immigration-backend'"
echo "  3. Check status: ssh $SERVER 'pm2 status'"
echo ""
echo -e "${GREEN}✅ Backend is now updated with latest checklist features!${NC}"
echo ""
