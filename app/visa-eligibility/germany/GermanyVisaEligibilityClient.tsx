...
export default function GermanyVisaEligibilityClient() {
  return (
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Free eligibility check — no sign-up required. Check your Germany visa eligibility for EU Blue Card, Job Seeker, Student, and more.
          </p>
