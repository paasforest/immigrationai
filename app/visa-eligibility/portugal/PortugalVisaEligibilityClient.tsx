...
export default function PortugalVisaEligibilityClient() {
  return (
      ...
      <section className="pt-12 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center space-x-2 bg-green-100 text-green-700 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sm font-medium">Portugal Visa Eligibility Check</span>
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
            Check Your Portugal Visa Eligibility
            <span className="block mt-2 bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">
              Golden Visa, D7, D2 & Student Visas
            </span>
          </h1>
      ...
      <section className="pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8 mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">Popular Portugal Visa Routes</h2>
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 text-emerald-500 mt-1 flex-shrink-0" />
                <span className="text-gray-700"><strong>Golden Visa</strong> - Investment-based residency (€500k+ property or capital transfer)</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 text-emerald-500 mt-1 flex-shrink-0" />
                <span className="text-gray-700"><strong>D7 Passive Income Visa</strong> - For retirees and passive income earners</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 text-emerald-500 mt-1 flex-shrink-0" />
                <span className="text-gray-700"><strong>D2 Entrepreneur Visa</strong> - For entrepreneurs and business investors</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 text-emerald-500 mt-1 flex-shrink-0" />
              ...
              <li className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 text-emerald-500 mt-1 flex-shrink-0" />
                <span className="text-gray-700"><strong>Work Visa</strong> - For skilled workers with job offers</span>
              </li>
            </ul>
          </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: 'Portugal Visa Eligibility Checker',
