...
const usaVisaTypes = [
  ...
  { value: 'usa_f1', label: 'F-1 Student Visa' },
  { value: 'usa_b1b2', label: 'B1/B2 Visitor Visa' },
...
export default function USAVisaEligibilityPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        setResult(data.data);
        trackEvent('usa_visa_eligibility_check', { visaType: formData.visaType });
      } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-blue-100">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
            ...
            <span className="block mt-2 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
              H-1B, F-1, B1/B2 & Green Card
            </span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Get instant AI-powered feedback on your USA visa eligibility. Check requirements for H-1B work visa, F-1 student visa, B1/B2 visitor visa, and family-based green cards.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid gap-8 lg:grid-cols-2">
          <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="text-sm font-medium text-slate-700 mb-2 block">USA Visa Type</label>
                <select
              ...
              <div>
                <label className="text-sm font-medium text-slate-700 mb-2 block">English Test (TOEFL/IELTS)</label>
                <select
                  className="w-full rounded-xl border-slate-200"
                ...
                >
                  ...
                  <option value="TOEFL 95+">TOEFL 95+</option>
              ...
              >
                {loading ? 'Checking...' : (
                  <>
                    <span>Check USA Visa Eligibility</span>
          ...
          <div className="bg-slate-900 text-white rounded-3xl shadow-xl p-8">
            {result ? (
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4">Why Check USA Visa Eligibility?</h3>
                <ul className="space-y-4 text-blue-100">
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" />
                    <span>AI assessment based on USCIS requirements and 214(b) criteria</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" />
                    <span>Understand H-1B lottery chances and requirements</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" />
                    <span>Check F-1 student visa eligibility and SEVIS requirements</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" />
                ...
                <div className="mt-8 bg-white/10 rounded-2xl p-4 border border-white/20">
                  <p className="text-sm text-blue-200">
                    <strong>Popular Routes:</strong> H-1B Work Visa, F-1 Student Visa, B1/B2 Visitor Visa, K-1 Fiancé Visa, and Family Green Cards.
                  </p>
                </div>
              </div>
            )}
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Ready to Start Your USA Application?</h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: 'USA Visa Eligibility Checker',
